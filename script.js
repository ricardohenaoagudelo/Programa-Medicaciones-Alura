...
const productos = {
  respiratorio: {
    ...
    fase2: [
      ...
      { nombre: 'CLORDIAGRO', dosis: { status1: 2.0, status2: 2.5, status3: 3.0 }, precioPorKilo: 17000, bacterias: ['M hyopneumoniae***','E. coli***', 'Pasteurella spp***','Salmonela spp**', 'Glaeserella*', 'Klepsiella spp***','Bordetella spp**', 'Enterobacter**', 'Estafilococcus spp**','Estreptococcus**', 'Corynebacterium spp*','TIEMPO DE RETIRO 15 DIAS'] },
      { nombre: 'DINAMIX 200', dosis: { status1: 0.5, status2: 0.75, status3: 1.0 }, precioPorKilo: 52000, bacterias: ['M hyopneumoniae***', 'Actinobacillus p*', 'Brachyspira spp**','Lawsonia**','Estafilococcus spp*','Estreptococcus*', 'TIEMPO DE RETIRO 5 DIAS'] },
      { nombre: 'DINAMIX 800', dosis: { status1: 0.125, status2: 0.2, status3: 0.25 }, precioPorKilo: 147500, bacterias: ['M hyopneumoniae***', 'Actinobacillus p*', 'Brachyspira spp**','Lawsonia**','Estafilococcus spp*','Estreptococcus*','TIEMPO DE RETIRO 5 DIAS'] },
      ...
      { nombre: 'LINCOX', dosis: { status1: 5.5, status2: 6.0, status3: 7.0 }, precioPorKilo: 80000, bacterias: ['M hyopneumoniae***','E. coli*', 'Salmonela spp*', 'Glaeserella**', 'Lawsonia***','Estafilococcus spp***','Estreptococcus***', 'Corynebacterium spp**','TIEMPO DE RETIRO 8 DIAS'] },
      { nombre: 'TILCOMIX', dosis: { status1: 0.5, status2: 0.750, status3: 1.0 }, precioPorKilo: 147000, bacterias: ['M hyopneumoniae**','E. coli**', 'Pasteurella spp***','Actinobacillus P***','TIEMPO DE RETIRO 7 DIAS'] },
    ...
    iniciador: [
      ...
      { nombre: 'FOSMICYNA 90', dosis: { status1: 0.25, status2: 0.3, status3: 0.4 }, precioPorKilo: 395000, bacterias: ['E. coli***', 'Pastereulla spp***','Salmonela spp***', 'Glaeserella***', 'Klebsiella spp***', 'Estafilococcus spp***', 'Streptococcus spp***', 'Clostridium*', 'TIEMPO DE RETIRO DE 7 DIAS'] },
      { nombre: 'NEOCYN', dosis: { status1: 0.25, status2: 0.3, status3: 0.4 }, precioPorKilo: 70000, bacterias: ['E. coli***', 'Pastereulla spp***','Salmonela spp***', 'Pseudomonas spp***', 'Glaeserella*', 'Klepsiella spp***', 'Enterobacter***', 'Listeria m*','TIEMPO DE RETIRO 3 DIAS'] },
      { nombre: 'DQCICLIN', dosis: { status1: 0.8, status2: 1.0, status3: 1.2 }, precioPorKilo: 277000, bacterias: ['M hyopneumoniae***','E. coli***', 'Pasteurella spp***','Salmonela spp***', 'Glaeserella*', 'Actinobacillus p*', 'Estafilococcus spp***', 'Streptococcus spp***', 'Clostridium**','Erisipelotrix**', 'Listeria m**','TIEMPO DE RETIRO 9 DIAS'] }
    ...
    finalizador: [
      { nombre: 'TILVALOSINA', dosis: { status1: 0.2, status2: 0.3, status3: 0.4 }, precioPorKilo: 210000, bacterias: ['Bacteria E', 'Bacteria F'] },
      { nombre: 'DINAMIX 200', dosis: { status1: 0.5, status2: 0.75, status3: 1.0 }, precioPorKilo: 52000, bacterias: ['M hyopneumoniae***', 'Actinobacillus p*', 'Brachyspira spp**','Lawsonia**','Estafilococcus spp*','Estreptococcus*', 'TIEMPO DE RETIRO 5 DIAS'] },
      { nombre: 'DINAMIX 800', dosis: { status1: 0.125, status2: 0.2, status3: 0.25 }, precioPorKilo: 147500, bacterias: ['M hyopneumoniae***', 'Actinobacillus p*', 'Brachyspira spp**','Lawsonia**','Estafilococcus spp*','Estreptococcus*','TIEMPO DE RETIRO 5 DIAS'] },
      { nombre: 'FENIFLOR', dosis: { status1: 0.4, status2: 0.6, status3: 0.75 }, precioPorKilo: 90000, bacterias: ['E. coli***', 'Pasteurella spp***','Salmonela spp***', 'Glaeserella*', 'Klepsiella spp***', 'Enterobacter*', 'Actinobacillus P***','TIEMPO DE RETIRO 5 DIAS'] }
